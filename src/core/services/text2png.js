...
const text2png = (text, options = {}) => {
  ...
  // console.log(options.localFontPath , options.localFontName)
  ...
  lineProps.forEach(lineProp => {
    ...
    ctx.fillText(lineProp.line, x, y +1.5);
...
function parseOptions(options) {
  return {
    ...
    shadowColor: or(options.shadowColor, "white"),
    shadowBlur: or(options.shadowBlur, 0),
    shadowOffsetX: or(options.shadowOffsetX, 0),
    shadowOffsetY: or(options.shadowOffsetY, 0),
