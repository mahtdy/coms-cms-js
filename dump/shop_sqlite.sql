...
--
-- Name: bank_check; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE bank_check OWNER TO postgres;

--
-- Name: bank_check_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE bank_check_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE bank_check_id_seq OWNER TO postgres;

--
-- Name: bank_check_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE bank_check_id_seq OWNED BY bank_check.id;


--
-- Name: bank_receipt; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE bank_receipt OWNER TO postgres;

--
-- Name: bank_receipt_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE bank_receipt_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE bank_receipt_id_seq OWNER TO postgres;

--
-- Name: bank_receipt_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE bank_receipt_id_seq OWNED BY bank_receipt.id;
...
--
-- Name: brand_category; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE brand_category OWNER TO postgres;

--
-- Name: brand_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE brand_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE brand_category_id_seq OWNER TO postgres;

--
-- Name: brand_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE brand_category_id_seq OWNED BY brand_category.id;


--
-- Name: brand_feature; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE brand_feature OWNER TO postgres;

--
-- Name: brand_feature_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE brand_feature_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE brand_feature_id_seq OWNER TO postgres;

--
-- Name: brand_feature_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE brand_feature_id_seq OWNED BY brand_feature.id;
...
--
-- Name: brand_image; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE brand_image OWNER TO postgres;

--
-- Name: brand_image_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE brand_image_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE brand_image_id_seq OWNER TO postgres;

--
-- Name: brand_image_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE brand_image_id_seq OWNED BY brand_image.id;


--
-- Name: category_brand; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE category_brand OWNER TO postgres;

--
-- Name: category_brand_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE category_brand_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE category_brand_id_seq OWNER TO postgres;

--
-- Name: category_brand_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE category_brand_id_seq OWNED BY category_brand.id;


--
-- Name: category_brand_price; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE category_brand_price (
    id integer NOT NULL,
    brand_id integer,
...
ALTER TABLE category_brand_price OWNER TO postgres;

--
-- Name: category_brand_price_action; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE category_brand_price_action (
    id integer NOT NULL,
    category_id character varying,
    is_increase boolean,
...
ALTER TABLE category_brand_price_action OWNER TO postgres;

--
-- Name: category_brand_price_action_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE category_brand_price_action ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME category_brand_price_action_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: category_brand_price_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE category_brand_price_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE category_brand_price_id_seq OWNER TO postgres;

--
-- Name: category_brand_price_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE category_brand_price_id_seq OWNED BY category_brand_price.id;


--
-- Name: category_feature; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE category_feature OWNER TO postgres;

--
-- Name: category_feature_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE category_feature_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE category_feature_id_seq OWNER TO postgres;

--
-- Name: category_feature_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE category_feature_id_seq OWNED BY category_feature.id;


--
-- Name: category_list; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE category_list OWNER TO postgres;

--
-- Name: category_list_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE category_list_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE category_list_id_seq OWNER TO postgres;

--
-- Name: category_list_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE category_list_id_seq OWNED BY category_list.id;


--
-- Name: category_rate; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE category_rate OWNER TO postgres;

--
-- Name: category_rate_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE category_rate_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE category_rate_id_seq OWNER TO postgres;

--
-- Name: category_rate_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE category_rate_id_seq OWNED BY category_rate.id;
...
ALTER TABLE cheque_id_seq OWNER TO postgres;
...
--
-- Name: cheque_transfer_product; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE cheque_transfer_product (
    id integer NOT NULL,
    product_id integer,
    order_id integer,
    unit_id integer,
...
ALTER TABLE cheque_transfer_product OWNER TO postgres;

--
-- Name: cheque_transfer_product_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE cheque_transfer_product_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE cheque_transfer_product_id_seq OWNER TO postgres;

--
-- Name: cheque_transfer_product_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE cheque_transfer_product_id_seq OWNED BY cheque_transfer_product.id;
...
--
-- Name: database_log; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE database_log OWNER TO postgres;

--
-- Name: database_log_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE database_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE database_log_id_seq OWNER TO postgres;

--
-- Name: database_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE database_log_id_seq OWNED BY database_log.id;


--
-- Name: discount_calander; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander (
    id integer NOT NULL,
...
ALTER TABLE discount_calander OWNER TO postgres;

--
-- Name: discount_calander_banner; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_banner (
    id integer NOT NULL,
...
ALTER TABLE discount_calander_banner OWNER TO postgres;

--
-- Name: discount_calander_banner_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_banner_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_banner_id_seq OWNER TO postgres;

--
-- Name: discount_calander_banner_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_banner_id_seq OWNED BY discount_calander_banner.id;


--
-- Name: discount_calander_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_id_seq OWNER TO postgres;

--
-- Name: discount_calander_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_id_seq OWNED BY discount_calander.id;


--
-- Name: discount_calander_list; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_list (
    id integer NOT NULL,
    discount_calander_id integer,
...
ALTER TABLE discount_calander_list OWNER TO postgres;

--
-- Name: discount_calander_list_banner_category; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_list_banner_category (
    id integer NOT NULL,
...
ALTER TABLE discount_calander_list_banner_category OWNER TO postgres;

--
-- Name: discount_calander_list_banner_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_list_banner_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_list_banner_category_id_seq OWNER TO postgres;

--
-- Name: discount_calander_list_banner_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_list_banner_category_id_seq OWNED BY discount_calander_list_banner_category.id;


--
-- Name: discount_calander_list_codes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_list_codes (
    id integer NOT NULL,
    discount_calander_list_id integer,
    code character varying
);
...
ALTER TABLE discount_calander_list_codes OWNER TO postgres;

--
-- Name: discount_calander_list_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_list_codes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_list_codes_id_seq OWNER TO postgres;

--
-- Name: discount_calander_list_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_list_codes_id_seq OWNED BY discount_calander_list_codes.id;


--
-- Name: discount_calander_list_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_list_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_list_id_seq OWNER TO postgres;

--
-- Name: discount_calander_list_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_list_id_seq OWNED BY discount_calander_list.id;


--
-- Name: discount_calander_msg; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_msg (
    id integer NOT NULL,
    discount_calander_id integer,
    name character varying,
...
ALTER TABLE discount_calander_msg OWNER TO postgres;

--
-- Name: discount_calander_msg_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_msg_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_msg_id_seq OWNER TO postgres;

--
-- Name: discount_calander_msg_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_msg_id_seq OWNED BY discount_calander_msg.id;


--
-- Name: discount_calander_msg_media; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_msg_media (
    id integer NOT NULL,
...
ALTER TABLE discount_calander_msg_media OWNER TO postgres;

--
-- Name: discount_calander_msg_media_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_msg_media_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_msg_media_id_seq OWNER TO postgres;

--
-- Name: discount_calander_msg_media_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_msg_media_id_seq OWNED BY discount_calander_msg_media.id;


--
-- Name: discount_calander_msg_reciever; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE discount_calander_msg_reciever (
    id integer NOT NULL,
    discount_calander_msg_id integer,
...
ALTER TABLE discount_calander_msg_reciever OWNER TO postgres;

--
-- Name: discount_calander_msg_reciever_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE discount_calander_msg_reciever_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE discount_calander_msg_reciever_id_seq OWNER TO postgres;

--
-- Name: discount_calander_msg_reciever_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE discount_calander_msg_reciever_id_seq OWNED BY discount_calander_msg_reciever.id;
...
--
-- Name: facktor_info; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE facktor_info (
    id integer NOT NULL,
    order_id integer,
    type character varying,
...
ALTER TABLE facktor_info OWNER TO postgres;

--
-- Name: facktor_info_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE facktor_info_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE facktor_info_id_seq OWNER TO postgres;

--
-- Name: facktor_info_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE facktor_info_id_seq OWNED BY facktor_info.id;
...
--
-- Name: feature_value; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE feature_value OWNER TO postgres;

--
-- Name: feature_value_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE feature_value_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE feature_value_id_seq OWNER TO postgres;

--
-- Name: feature_value_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE feature_value_id_seq OWNED BY feature_value.id;


--
-- Name: feature_values_category; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE feature_values_category (
    id integer NOT NULL,
    feature_value_id integer,
    feature_id integer,
    category_id character varying,
...
ALTER TABLE feature_values_category OWNER TO postgres;

--
-- Name: feature_values_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE feature_values_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE feature_values_category_id_seq OWNER TO postgres;

--
-- Name: feature_values_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE feature_values_category_id_seq OWNED BY feature_values_category.id;


--
-- Name: financial_document; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE financial_document OWNER TO postgres;

--
-- Name: financial_document_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE financial_document_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE financial_document_id_seq OWNER TO postgres;

--
-- Name: financial_document_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE financial_document_id_seq OWNED BY financial_document.id;
...
ALTER TABLE giftcard OWNER TO postgres;

--
-- Name: giftcard_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE giftcard_id_seq OWNER TO postgres;

--
-- Name: giftcard_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: holding_hands; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE holding_hands (
    id integer NOT NULL,
    order_id integer,
    account_id integer,
    amount character varying,
...
ALTER TABLE holding_hands OWNER TO postgres;

--
-- Name: holding_hands_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE holding_hands_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE holding_hands_id_seq OWNER TO postgres;

--
-- Name: holding_hands_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE holding_hands_id_seq OWNED BY holding_hands.id;


--
-- Name: log_price_action; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE log_price_action (
    id integer NOT NULL,
...
ALTER TABLE log_price_action OWNER TO postgres;

--
-- Name: log_price_action_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE log_price_action ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME log_price_action_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE my_order OWNER TO postgres;
...
ALTER SEQUENCE order_id_seq OWNED BY my_order.id;
...
--
-- Name: order_send; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE order_send OWNER TO postgres;

--
-- Name: order_send_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE order_send_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE order_send_id_seq OWNER TO postgres;

--
-- Name: order_send_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE order_send_id_seq OWNED BY order_send.id;
...
ALTER TABLE pos_id_seq OWNER TO postgres;
...
ALTER TABLE pos_transactions OWNER TO postgres;

--
-- Name: pos_transactions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE pos_transactions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE pos_transactions_id_seq OWNER TO postgres;

--
-- Name: pos_transactions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE pos_transactions_id_seq OWNED BY pos_transactions.id;


--
-- Name: poz_transactions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE poz_transactions (
    id integer NOT NULL,
    pos_id integer,
    account_id integer,
    order_id character varying,
...
ALTER TABLE poz_transactions OWNER TO postgres;

--
-- Name: poz_transactions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE poz_transactions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE poz_transactions_id_seq OWNER TO postgres;

--
-- Name: poz_transactions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE poz_transactions_id_seq OWNED BY poz_transactions.id;


--
-- Name: price_config_term; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE price_config_term (
    id integer NOT NULL,
    config character varying
);


ALTER TABLE price_config_term OWNER TO postgres;

--
-- Name: price_config_term_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE price_config_term_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE price_config_term_id_seq OWNER TO postgres;

--
-- Name: price_config_term_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE price_config_term_id_seq OWNED BY price_config_term.id;


--
-- Name: price_feature_values; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE price_feature_values (
    id integer NOT NULL,
    feature_id integer,
    feature_value_id integer,
    product_price_id integer
...
ALTER TABLE price_feature_values OWNER TO postgres;

--
-- Name: price_feature_values_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE price_feature_values_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE price_feature_values_id_seq OWNER TO postgres;

--
-- Name: price_feature_values_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE price_feature_values_id_seq OWNED BY price_feature_values.id;
...
--
-- Name: product_barcode; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE product_barcode OWNER TO postgres;

--
-- Name: product_barcode_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE product_barcode_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE product_barcode_id_seq OWNER TO postgres;

--
-- Name: product_barcode_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE product_barcode_id_seq OWNED BY product_barcode.id;


--
-- Name: product_feature_values; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE product_feature_values OWNER TO postgres;

--
-- Name: product_feature_values_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE product_feature_values_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE product_feature_values_id_seq OWNER TO postgres;

--
-- Name: product_feature_values_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE product_feature_values_id_seq OWNED BY product_feature_values.id;
...
ALTER TABLE product_price_id_seq OWNER TO postgres;
...
ALTER TABLE product_rate OWNER TO postgres;

--
-- Name: product_rate_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE product_rate_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE product_rate_id_seq OWNER TO postgres;

--
-- Name: product_rate_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE product_rate_id_seq OWNED BY product_rate.id;
...
ALTER TABLE rate_id_seq OWNER TO postgres;
...
--
-- Name: stock_taking; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE stock_taking OWNER TO postgres;

--
-- Name: stock_taking_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE stock_taking_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE stock_taking_id_seq OWNER TO postgres;

--
-- Name: stock_taking_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE stock_taking_id_seq OWNED BY stock_taking.id;


--
-- Name: stock_taking_product; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE stock_taking_product (
    id integer NOT NULL,
...
ALTER TABLE stock_taking_product OWNER TO postgres;

--
-- Name: stock_taking_product_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE stock_taking_product_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE stock_taking_product_id_seq OWNER TO postgres;

--
-- Name: stock_taking_product_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE stock_taking_product_id_seq OWNED BY stock_taking_product.id;
...
ALTER TABLE task_queue OWNER TO postgres;

--
-- Name: task_queue_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE task_queue_id_seq OWNER TO postgres;

--
-- Name: task_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE task_queue_id_seq OWNED BY task_queue.id;
...
--
-- Name: warehouse_managers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE warehouse_managers OWNER TO postgres;

--
-- Name: warehouse_managers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE warehouse_managers_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE warehouse_managers_id_seq OWNER TO postgres;

--
-- Name: warehouse_managers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE warehouse_managers_id_seq OWNED BY warehouse_managers.id;


--
-- Name: warehouse_phones; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE warehouse_phones OWNER TO postgres;

--
-- Name: warehouse_phones_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE warehouse_phones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE warehouse_phones_id_seq OWNER TO postgres;

--
-- Name: warehouse_phones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE warehouse_phones_id_seq OWNED BY warehouse_phones.id;


--
-- Name: wastage; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE wastage OWNER TO postgres;

--
-- Name: wastage_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE wastage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE wastage_id_seq OWNER TO postgres;

--
-- Name: wastage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE wastage_id_seq OWNED BY wastage.id;


--
-- Name: withdraw_wallet; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE withdraw_wallet OWNER TO postgres;

--
-- Name: withdraw_wallet_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE withdraw_wallet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE withdraw_wallet_id_seq OWNER TO postgres;

--
-- Name: withdraw_wallet_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE withdraw_wallet_id_seq OWNED BY withdraw_wallet.id;
...
--
-- Name: bank_check id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_check ALTER COLUMN id SET DEFAULT nextval('bank_check_id_seq'::regclass);


--
-- Name: bank_receipt id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_receipt ALTER COLUMN id SET DEFAULT nextval('bank_receipt_id_seq'::regclass);
...
--
-- Name: brand_category id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_category ALTER COLUMN id SET DEFAULT nextval('brand_category_id_seq'::regclass);


--
-- Name: brand_feature id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_feature ALTER COLUMN id SET DEFAULT nextval('brand_feature_id_seq'::regclass);


--
-- Name: brand_image id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_image ALTER COLUMN id SET DEFAULT nextval('brand_image_id_seq'::regclass);


--
-- Name: category_brand id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand ALTER COLUMN id SET DEFAULT nextval('category_brand_id_seq'::regclass);


--
-- Name: category_brand_price id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand_price ALTER COLUMN id SET DEFAULT nextval('category_brand_price_id_seq'::regclass);


--
-- Name: category_feature id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_feature ALTER COLUMN id SET DEFAULT nextval('category_feature_id_seq'::regclass);


--
-- Name: category_list id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_list ALTER COLUMN id SET DEFAULT nextval('category_list_id_seq'::regclass);


--
-- Name: category_rate id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_rate ALTER COLUMN id SET DEFAULT nextval('category_rate_id_seq'::regclass);


--
-- Name: cheque id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque ALTER COLUMN id SET DEFAULT nextval('cheque_id_seq'::regclass);


--
-- Name: cheque_transfer_product id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product ALTER COLUMN id SET DEFAULT nextval('cheque_transfer_product_id_seq'::regclass);
...
--
-- Name: database_log id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY database_log ALTER COLUMN id SET DEFAULT nextval('database_log_id_seq'::regclass);


--
-- Name: discount_calander id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander ALTER COLUMN id SET DEFAULT nextval('discount_calander_id_seq'::regclass);


--
-- Name: discount_calander_banner id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_banner ALTER COLUMN id SET DEFAULT nextval('discount_calander_banner_id_seq'::regclass);


--
-- Name: discount_calander_list id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list ALTER COLUMN id SET DEFAULT nextval('discount_calander_list_id_seq'::regclass);


--
-- Name: discount_calander_list_banner_category id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_banner_category ALTER COLUMN id SET DEFAULT nextval('discount_calander_list_banner_category_id_seq'::regclass);


--
-- Name: discount_calander_list_codes id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_codes ALTER COLUMN id SET DEFAULT nextval('discount_calander_list_codes_id_seq'::regclass);


--
-- Name: discount_calander_msg id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg ALTER COLUMN id SET DEFAULT nextval('discount_calander_msg_id_seq'::regclass);


--
-- Name: discount_calander_msg_media id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_media ALTER COLUMN id SET DEFAULT nextval('discount_calander_msg_media_id_seq'::regclass);


--
-- Name: discount_calander_msg_reciever id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_reciever ALTER COLUMN id SET DEFAULT nextval('discount_calander_msg_reciever_id_seq'::regclass);
...
--
-- Name: facktor_info id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY facktor_info ALTER COLUMN id SET DEFAULT nextval('facktor_info_id_seq'::regclass);
...
--
-- Name: feature_value id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feature_value ALTER COLUMN id SET DEFAULT nextval('feature_value_id_seq'::regclass);


--
-- Name: feature_values_category id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feature_values_category ALTER COLUMN id SET DEFAULT nextval('feature_values_category_id_seq'::regclass);


--
-- Name: financial_document id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document ALTER COLUMN id SET DEFAULT nextval('financial_document_id_seq'::regclass);


--
-- Name: giftcard id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY giftcard ALTER COLUMN id SET DEFAULT nextval('giftcard_id_seq'::regclass);


--
-- Name: holding_hands id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY holding_hands ALTER COLUMN id SET DEFAULT nextval('holding_hands_id_seq'::regclass);


--
-- Name: my_order id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY my_order ALTER COLUMN id SET DEFAULT nextval('order_id_seq'::regclass);
...
--
-- Name: order_send id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY order_send ALTER COLUMN id SET DEFAULT nextval('order_send_id_seq'::regclass);


--
-- Name: order_type id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY pos_transactions ALTER COLUMN id SET DEFAULT nextval('pos_transactions_id_seq'::regclass);


--
-- Name: poz_transactions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poz_transactions ALTER COLUMN id SET DEFAULT nextval('poz_transactions_id_seq'::regclass);


--
-- Name: price_config_term id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_config_term ALTER COLUMN id SET DEFAULT nextval('price_config_term_id_seq'::regclass);


--
-- Name: price_feature_values id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_feature_values ALTER COLUMN id SET DEFAULT nextval('price_feature_values_id_seq'::regclass);
...
--
-- Name: product_barcode id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_barcode ALTER COLUMN id SET DEFAULT nextval('product_barcode_id_seq'::regclass);


--
-- Name: product_feature_values id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_feature_values ALTER COLUMN id SET DEFAULT nextval('product_feature_values_id_seq'::regclass);
...
--
-- Name: product_rate id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_rate ALTER COLUMN id SET DEFAULT nextval('product_rate_id_seq'::regclass);
...
--
-- Name: stock_taking id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY stock_taking ALTER COLUMN id SET DEFAULT nextval('stock_taking_id_seq'::regclass);


--
-- Name: stock_taking_product id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY stock_taking_product ALTER COLUMN id SET DEFAULT nextval('stock_taking_product_id_seq'::regclass);


--
-- Name: task_queue id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY task_queue ALTER COLUMN id SET DEFAULT nextval('task_queue_id_seq'::regclass);
...
--
-- Name: warehouse_managers id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY warehouse_managers ALTER COLUMN id SET DEFAULT nextval('warehouse_managers_id_seq'::regclass);


--
-- Name: warehouse_phones id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY warehouse_phones ALTER COLUMN id SET DEFAULT nextval('warehouse_phones_id_seq'::regclass);


--
-- Name: wastage id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wastage ALTER COLUMN id SET DEFAULT nextval('wastage_id_seq'::regclass);


--
-- Name: withdraw_wallet id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY withdraw_wallet ALTER COLUMN id SET DEFAULT nextval('withdraw_wallet_id_seq'::regclass);
...
COPY account (id, account_number, card_number, shaba_number, bank, type, title, is_actvie, created_at, deleted_at) FROM stdin;
...
--
-- Data for Name: bank_check; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY bank_check (id, order_id, account_id, amount, number, account_number, due_date, bank, owner, status, image, created_at, deleted_at, user_id, manager_id, is_accept, type_id, is_add_transaction, status_id, is_add_wallet) FROM stdin;
\.


--
-- Data for Name: bank_receipt; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY bank_receipt (id, order_id, account_id, amount, number, due_date, account_number, image, created_at, deleted_at, user_id, manager_id, is_accept, type_id, is_add_transaction, is_add_wallet) FROM stdin;
\.
...
COPY basket (id, product_id, product_price_id, warehouse_id, user_id, type_user_id, inserted_at, finished_at, number, per_price, send_by, next_buy, order_status) FROM stdin;
...
COPY brand (id, title, title_en, logo, alt_logo, description, video, url, deleted_at, inserted_at, percentage_floor, percentage_ceiling, publishdate, isdraft, language, viewmode, seo, refrence_id, is_seo_url_ok, seo_url_last_response, seo_id) FROM stdin;
...
--
-- Data for Name: brand_category; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY brand_category (id, brand_id, category, inserted_at) FROM stdin;
\.


--
-- Data for Name: brand_feature; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY brand_feature (id, brand_id, feature_id, feature_value_id, sort_id_feature, sort_id_feature_value) FROM stdin;
1	1	1	1	1	1
2	1	1	5	1	1
3	1	1	1	1	1
\.
...
--
-- Data for Name: brand_image; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY brand_image (id, brand_id, url, alt, deleted_at, inserted_at) FROM stdin;
...
--
-- Data for Name: category_brand; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY category_brand (id, brand_id, category_id, sort_id) FROM stdin;
\.


--
-- Data for Name: category_brand_price; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY category_brand_price (id, brand_id, category, prcentage_floor, prcentage_ceiling) FROM stdin;
1	35	1	1	5
\.


--
-- Data for Name: category_brand_price_action; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY category_brand_price_action (id, category_id, is_increase, percentage, brand_id, created_at, self_id) FROM stdin;
...
--
-- Data for Name: category_feature; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY category_feature (id, feature_id, category_id, sort_id) FROM stdin;
\.
...
COPY category_list (id, product_id, category_id, order_num) FROM stdin;
1	1	موبایل	1
2	1	1	3
3	1	tv	3
\.
...
--
-- Data for Name: category_rate; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY category_rate (id, rate_id, category_id, order_num) FROM stdin;
\.
...
COPY cheque (id, order_id, warehouse_id, warehouse_manager_id, title, code, receive_at, created_at, description, deleted_at, type, type_id) FROM stdin;
...
--
-- Data for Name: cheque_transfer_product; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY cheque_transfer_product (id, product_id, order_id, unit_id, warehouse_id, wastage_id, cheque_id, transfer_id, stock_taking_product_id, number, description, created_at, deleted_at, is_increase, type, refrence_id) FROM stdin;
...
COPY credit (id, amount, due_date, user_id, manager_id, created_at, deleted_at, left_over) FROM stdin;
\.


--
-- Data for Name: database_log; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY database_log (id, created_at, class_name, func_name, error, arg, kwargs, befor_data, after_data, type_query, username, result, code) FROM stdin;
...
--
-- Data for Name: discount_calander; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander (id, name, start_date, end_date, landing_page_url, num_user_can_buy, num_product_salse, num_product, minimum_basket_price, maximum_apply_discount, is_finished, is_actice, inserted_at, deleted_at, num_total_use, num_per_session, prevent_losses) FROM stdin;
\.


--
-- Data for Name: discount_calander_banner; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_banner (id, discount_calander_id, url, alt, page_refer) FROM stdin;
\.


--
-- Data for Name: discount_calander_list; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_list (id, discount_calander_id, discount_price, discount_precentage, percentage_up, percentage_down, price_up, price_down, wich_one) FROM stdin;
\.


--
-- Data for Name: discount_calander_list_banner_category; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_list_banner_category (id, discount_calander_list_id, brand_id, category_id) FROM stdin;
\.


--
-- Data for Name: discount_calander_list_codes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_list_codes (id, discount_calander_list_id, code) FROM stdin;
\.


--
-- Data for Name: discount_calander_msg; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_msg (id, discount_calander_id, name, send_date, text) FROM stdin;
\.


--
-- Data for Name: discount_calander_msg_media; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_msg_media (id, discount_calander_msg_id, url, type) FROM stdin;
\.


--
-- Data for Name: discount_calander_msg_reciever; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY discount_calander_msg_reciever (id, discount_calander_msg_id, reciever) FROM stdin;
\.
...
COPY error_log (id, created_at, class_name, func_name, error, arg, kwargs, count, last_record) FROM stdin;
...
--
-- Data for Name: facktor_info; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY facktor_info (id, order_id, type, value, key) FROM stdin;
\.
...
COPY feature (id, title, show_up, inserted_at, deleted_at, language) FROM stdin;
...
--
-- Data for Name: feature_value; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY feature_value (id, value, language) FROM stdin;
1	یک ترابایت	\N
2	Intel	\N
3	چهار گیگابایت	\N
4	Core i3	\N
...
--
-- Data for Name: feature_values_category; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY feature_values_category (id, feature_value_id, feature_id, category_id, is_filter, inserted_at, deleted_at, feature_sort_id, language, feature_value_sort_id) FROM stdin;
...
--
-- Data for Name: financial_document; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY financial_document (id, order_id, account_id, wallet_id, transaction_id, withdraw_wallet_id, text, user_id, amount, account_number_orgin, account_number_goal, created_at, deleted_at, is_pattern, type_id, type_peyment, peyment_getway_id) FROM stdin;
\.
...
COPY giftcard (id, code, receiver, amount, creator, inserted_at, is_use, name, card_url) FROM stdin;
\.


--
-- Data for Name: holding_hands; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY holding_hands (id, order_id, account_id, amount, payer, user_id_receiver, account_number, created_at, deleted_at, type_id, is_add_transaction, is_add_wallet, is_transfer) FROM stdin;
\.


--
-- Data for Name: log_price_action; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY log_price_action (id, category_brand_price_action_id, action, product_price_id, created_at, workmate, sell, sell_ceiling, sell_floor) FROM stdin;
...
COPY order_products (id, order_id, product_id, order_send_id, unit_price, num, total_price, gain, send_by, tax, description, is_increase_balance, gain_percentage, tax_percentage, deleted_at, refrence_id) FROM stdin;
3	10	1	string	1000	10	10000	0	string	0	string	t	0	0	\N	string
\.


--
-- Data for Name: order_send; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY order_send (id, order_id, sending_type, pursuit_code, recieve_date, sending_price, recieve_code, recieve_start_time, recieve_end_time, total_price) FROM stdin;
\.
...
COPY order_type (id, type_name, increase_balance, increase_financial_balance, description, type_id) FROM stdin;
...
COPY pos (id, account_id, name, account_bank, account_number, created_at, deleted_at) FROM stdin;
...
COPY pos_transactions (id, pos_id, account_id, order_id, created_at, deleted_at, account_number, user_id, type_id, is_add_transaction, is_add_wallet, amount) FROM stdin;
\.


--
-- Data for Name: poz_transactions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY poz_transactions (id, pos_id, account_id, order_id, created_at, deleted_at, account_number, user_id, type_id, is_add_transaction, is_add_wallet, poz_id, amount) FROM stdin;
\.


--
-- Data for Name: price_config_term; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY price_config_term (id, config) FROM stdin;
1	none
\.


--
-- Data for Name: price_feature_values; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY price_feature_values (id, feature_id, feature_value_id, product_price_id) FROM stdin;
1	2	1	2
\.
...
--
-- Data for Name: product_barcode; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY product_barcode (id, product_id, value, key, refrence_id) FROM stdin;
\.


--
-- Data for Name: product_feature_values; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY product_feature_values (id, product_id, feature_id, refrence_id, feature_value_id) FROM stdin;
1	1	3	string	5
\.
...
COPY product_images (id, product_id, url, alt, color, deleted_at, inserted_at, type_media) FROM stdin;
\.
...
COPY product_price (id, product_id, order_id, unit_id, buy, workmate, sell_ceiling, sell_floor, sell_ai, percentage_ceiling, percentage_floor, percentage_ai, balance, sell, is_active, inserted_at, seller_id, guaranty_id, refrence_id) FROM stdin;
...
COPY product_rate (id, product_id, rate_id, refrence_id) FROM stdin;
1	1	1	string
2	1	2	string
3	1	3	string
\.
...
COPY review (id, product_id, title, text, user_id, inserted_at, deleted_at, refrence_id) FROM stdin;
...
--
-- Data for Name: stock_taking; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY stock_taking (id, warehouse_id, warehouse_manager_id, code, description, created_at, deleted_at) FROM stdin;
...
--
-- Data for Name: stock_taking_product; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY stock_taking_product (id, current_balance, counting_one, counting_second, counting_third, counting_final, description, created_at, deleted_at, refrence_id, stock_taking_id, product_id) FROM stdin;
...
COPY task_queue (id, date, hour, miunte, args, kwargs, status, created_at, updated_at, class_name, function_name, response_error) FROM stdin;
...
COPY transaction (id, order_id, account_id, wallet_id, pos_id, account_number_origin, account_card_origin, account_shaba_origin, account_number_goal, account_card_goal, account_shaba_goal, amount, peyment_getway_id, type_manual, id_manual, status, type_id, created_at, transfer_at, deleted_at, user_id, status_id) FROM stdin;
...
COPY transfer (id, warehouse_origin_id, warehouse_manager_origin_id, code, title, warehouse_goal_id, warehouse_manager_goal_id, created_at, submit_at, receive_at, deleted_at) FROM stdin;
...
COPY unit (id, title, language) FROM stdin;
1	کیلوگرم	\N
2	سانتی متر	\N
3	متر	\N
4	تعداد	\N
...
COPY wallet (id, order_id, transaction_id, user_id, amount, is_increase, type_id, table_name, table_id, created_at, deleted_at, is_real, gift_reminder) FROM stdin;
...
COPY warehouse (id, title, height, dimension, address, postal_code, x_location, y_location, inserted_at, deleted_at, is_active) FROM stdin;
...
--
-- Data for Name: warehouse_managers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY warehouse_managers (id, warehouse_id, manager_id) FROM stdin;
2	2	string
\.


--
-- Data for Name: warehouse_phones; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY warehouse_phones (id, warehouse_id, phone) FROM stdin;
\.


--
-- Data for Name: wastage; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY wastage (id, unit_id, warehouse_id, product_id, warehouse_manager_id, number, description, created_at, deleted_at, refrence_id) FROM stdin;
...
--
-- Data for Name: withdraw_wallet; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY withdraw_wallet (id, account_id, user_id, amount, created_at, status, account_number, account_card, account_shaba) FROM stdin;
\.
...
--
-- Name: bank_check_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('bank_check_id_seq', 1, false);


--
-- Name: bank_receipt_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('bank_receipt_id_seq', 1, false);
...
SELECT pg_catalog.setval('basket_id_seq', 2, true);


--
-- Name: brand_category_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('brand_category_id_seq', 1, false);


--
-- Name: brand_feature_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('brand_feature_id_seq', 3, true);
...
--
-- Name: brand_image_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('brand_image_id_seq', 5, true);


--
-- Name: category_brand_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_brand_id_seq', 1, false);


--
-- Name: category_brand_price_action_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_brand_price_action_id_seq', 21, true);


--
-- Name: category_brand_price_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_brand_price_id_seq', 1, true);


--
-- Name: category_feature_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_feature_id_seq', 1, false);


--
-- Name: category_list_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_list_id_seq', 3, true);


--
-- Name: category_rate_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('category_rate_id_seq', 1, false);
...
SELECT pg_catalog.setval('cheque_id_seq', 64, true);


--
-- Name: cheque_transfer_product_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('cheque_transfer_product_id_seq', 32, true);
...
--
-- Name: database_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('database_log_id_seq', 552, true);


--
-- Name: discount_calander_banner_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_banner_id_seq', 1, false);


--
-- Name: discount_calander_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_id_seq', 1, false);


--
-- Name: discount_calander_list_banner_category_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_list_banner_category_id_seq', 1, false);


--
-- Name: discount_calander_list_codes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_list_codes_id_seq', 1, false);


--
-- Name: discount_calander_list_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_list_id_seq', 1, false);


--
-- Name: discount_calander_msg_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_msg_id_seq', 1, false);


--
-- Name: discount_calander_msg_media_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_msg_media_id_seq', 1, false);


--
-- Name: discount_calander_msg_reciever_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('discount_calander_msg_reciever_id_seq', 1, false);
...
SELECT pg_catalog.setval('error_log_id_seq', 161, true);


--
-- Name: facktor_info_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('facktor_info_id_seq', 1, false);
...
SELECT pg_catalog.setval('feature_id_seq', 33, true);


--
-- Name: feature_value_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('feature_value_id_seq', 5, true);


--
-- Name: feature_values_category_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('feature_values_category_id_seq', 2, true);


--
-- Name: financial_document_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('financial_document_id_seq', 1, false);


--
-- Name: giftcard_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('giftcard_id_seq', 1, false);


--
-- Name: holding_hands_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('holding_hands_id_seq', 1, false);


--
-- Name: log_price_action_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('log_price_action_id_seq', 8, true);
...
SELECT pg_catalog.setval('order_id_seq', 13, true);
...
SELECT pg_catalog.setval('order_products_id_seq', 3, true);


--
-- Name: order_send_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('order_send_id_seq', 1, false);
...
SELECT pg_catalog.setval('order_type_id_seq', 288, true);
...
SELECT pg_catalog.setval('pos_id_seq', 1, true);
...
SELECT pg_catalog.setval('pos_transactions_id_seq', 1, false);


--
-- Name: poz_transactions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('poz_transactions_id_seq', 1, false);


--
-- Name: price_config_term_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('price_config_term_id_seq', 1, true);


--
-- Name: price_feature_values_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('price_feature_values_id_seq', 1, true);


--
-- Name: product_barcode_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('product_barcode_id_seq', 1, false);


--
-- Name: product_feature_values_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('product_feature_values_id_seq', 3, true);
...
SELECT pg_catalog.setval('product_price_id_seq', 3, true);
...
SELECT pg_catalog.setval('product_rate_id_seq', 4, true);
...
SELECT pg_catalog.setval('rate_id_seq', 7, true);
...
SELECT pg_catalog.setval('review_id_seq', 2, true);


--
-- Name: stock_taking_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('stock_taking_id_seq', 19, true);


--
-- Name: stock_taking_product_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('stock_taking_product_id_seq', 10, true);


--
-- Name: task_queue_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('task_queue_id_seq', 2, true);
...
SELECT pg_catalog.setval('transfer_id_seq', 9, true);
...
SELECT pg_catalog.setval('unit_id_seq', 4, true);
...
--
-- Name: warehouse_managers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('warehouse_managers_id_seq', 2, true);


--
-- Name: warehouse_phones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('warehouse_phones_id_seq', 1, false);


--
-- Name: wastage_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('wastage_id_seq', 19, true);


--
-- Name: withdraw_wallet_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('withdraw_wallet_id_seq', 1, false);
...
--
-- Name: bank_check bank_check_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_check
    ADD CONSTRAINT bank_check_pkey PRIMARY KEY (id);


--
-- Name: bank_receipt bank_receipt_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_receipt
...
--
-- Name: brand_category brand_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: brand_feature brand_feature_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_feature
    ADD CONSTRAINT brand_feature_pkey PRIMARY KEY (id);


--
-- Name: brand_image brand_image_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_image
...
--
-- Name: category_brand category_brand_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_brand_price_action category_brand_price_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand_price_action
    ADD CONSTRAINT category_brand_price_action_pkey PRIMARY KEY (id);


--
-- Name: category_brand_price category_brand_price_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand_price
    ADD CONSTRAINT category_brand_price_pkey PRIMARY KEY (id);


--
-- Name: category_feature category_feature_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_feature
    ADD CONSTRAINT category_feature_pkey PRIMARY KEY (id);


--
-- Name: category_list category_list_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_list
    ADD CONSTRAINT category_list_pkey PRIMARY KEY (id);


--
-- Name: category_rate category_rate_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_rate
...
--
-- Name: cheque_transfer_product cheque_transfer_product_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
...
--
-- Name: database_log database_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: discount_calander_banner discount_calander_banner_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_banner
    ADD CONSTRAINT discount_calander_banner_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_list_banner_category discount_calander_list_banner_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_banner_category
    ADD CONSTRAINT discount_calander_list_banner_category_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_list_codes discount_calander_list_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_codes
    ADD CONSTRAINT discount_calander_list_codes_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_list discount_calander_list_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list
    ADD CONSTRAINT discount_calander_list_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_msg_media discount_calander_msg_media_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_media
    ADD CONSTRAINT discount_calander_msg_media_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_msg discount_calander_msg_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg
    ADD CONSTRAINT discount_calander_msg_pkey PRIMARY KEY (id);


--
-- Name: discount_calander_msg_reciever discount_calander_msg_reciever_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_reciever
    ADD CONSTRAINT discount_calander_msg_reciever_pkey PRIMARY KEY (id);


--
-- Name: discount_calander discount_calander_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander
...
--
-- Name: facktor_info facktor_info_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY facktor_info
...
--
-- Name: feature feature_title_u; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: feature_value feature_value_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: feature_values_category feature_values_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feature_values_category
    ADD CONSTRAINT feature_values_category_pkey PRIMARY KEY (id);


--
-- Name: financial_document financial_document_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
...
--
-- Name: holding_hands holding_hands_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY holding_hands
    ADD CONSTRAINT holding_hands_pkey PRIMARY KEY (id);


--
-- Name: log_price_action log_price_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY log_price_action
    ADD CONSTRAINT log_price_action_pkey PRIMARY KEY (id);


--
-- Name: my_order order_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY my_order
...
--
-- Name: order_send order_send_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY order_send
...
ALTER TABLE ONLY pos_transactions
    ADD CONSTRAINT pos_transactions_pkey PRIMARY KEY (id);


--
-- Name: poz_transactions poz_transactions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poz_transactions
    ADD CONSTRAINT poz_transactions_pkey PRIMARY KEY (id);


--
-- Name: price_config_term price_config_term_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_config_term
    ADD CONSTRAINT price_config_term_pkey PRIMARY KEY (id);


--
-- Name: price_feature_values price_feature_values_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_feature_values
    ADD CONSTRAINT price_feature_values_pkey PRIMARY KEY (id);


--
-- Name: product_barcode product_barcode_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_barcode
    ADD CONSTRAINT product_barcode_pkey PRIMARY KEY (id);


--
-- Name: product_feature_values product_feature_values_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_feature_values
...
--
-- Name: stock_taking stock_taking_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY stock_taking
    ADD CONSTRAINT stock_taking_pkey PRIMARY KEY (id);


--
-- Name: stock_taking_product stock_taking_product_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY stock_taking_product
...
--
-- Name: unit unit_title_u; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: warehouse_managers warehouse_managers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY warehouse_managers
    ADD CONSTRAINT warehouse_managers_pkey PRIMARY KEY (id);


--
-- Name: warehouse_phones warehouse_phones_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY warehouse_phones
...
--
-- Name: wastage wastage_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wastage
    ADD CONSTRAINT wastage_pkey PRIMARY KEY (id);


--
-- Name: withdraw_wallet withdraw_wallet_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY withdraw_wallet
...
--
-- Name: ix_bank_check_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_bank_check_id ON bank_check USING btree (id);


--
-- Name: ix_bank_receipt_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_bank_receipt_id ON bank_receipt USING btree (id);


--
-- Name: ix_basket_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_basket_id ON basket USING btree (id);


--
-- Name: ix_brand_category_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_brand_category_id ON brand_category USING btree (id);


--
-- Name: ix_brand_feature_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_brand_feature_id ON brand_feature USING btree (id);
...
CREATE INDEX ix_brand_id ON brand USING btree (id);


--
-- Name: ix_brand_image_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_brand_image_id ON brand_image USING btree (id);


--
-- Name: ix_category_brand_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_category_brand_id ON category_brand USING btree (id);


--
-- Name: ix_category_brand_price_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_category_brand_price_id ON category_brand_price USING btree (id);


--
-- Name: ix_category_feature_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_category_feature_id ON category_feature USING btree (id);


--
-- Name: ix_category_list_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_category_list_id ON category_list USING btree (id);


--
-- Name: ix_category_rate_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_category_rate_id ON category_rate USING btree (id);


--
-- Name: ix_cheque_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_cheque_id ON cheque USING btree (id);


--
-- Name: ix_cheque_transfer_product_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_cheque_transfer_product_id ON cheque_transfer_product USING btree (id);


--
-- Name: ix_credit_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_credit_id ON credit USING btree (id);


--
-- Name: ix_database_log_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_database_log_id ON database_log USING btree (id);


--
-- Name: ix_discount_calander_banner_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_banner_id ON discount_calander_banner USING btree (id);


--
-- Name: ix_discount_calander_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_id ON discount_calander USING btree (id);


--
-- Name: ix_discount_calander_list_banner_category_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_list_banner_category_id ON discount_calander_list_banner_category USING btree (id);


--
-- Name: ix_discount_calander_list_codes_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_list_codes_id ON discount_calander_list_codes USING btree (id);


--
-- Name: ix_discount_calander_list_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_list_id ON discount_calander_list USING btree (id);


--
-- Name: ix_discount_calander_msg_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_msg_id ON discount_calander_msg USING btree (id);


--
-- Name: ix_discount_calander_msg_media_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_msg_media_id ON discount_calander_msg_media USING btree (id);


--
-- Name: ix_discount_calander_msg_reciever_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_discount_calander_msg_reciever_id ON discount_calander_msg_reciever USING btree (id);


--
-- Name: ix_error_log_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_error_log_id ON error_log USING btree (id);


--
-- Name: ix_facktor_info_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_facktor_info_id ON facktor_info USING btree (id);


--
-- Name: ix_feature_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_feature_id ON feature USING btree (id);


--
-- Name: ix_feature_value_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_feature_value_id ON feature_value USING btree (id);


--
-- Name: ix_feature_values_category_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_feature_values_category_id ON feature_values_category USING btree (id);


--
-- Name: ix_financial_document_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_financial_document_id ON financial_document USING btree (id);


--
-- Name: ix_giftcard_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_giftcard_id ON giftcard USING btree (id);


--
-- Name: ix_holding_hands_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_holding_hands_id ON holding_hands USING btree (id);
...
CREATE INDEX ix_order_id ON my_order USING btree (id);


--
-- Name: ix_order_products_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_order_products_id ON order_products USING btree (id);


--
-- Name: ix_order_send_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_order_send_id ON order_send USING btree (id);


--
-- Name: ix_order_type_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_order_type_id ON order_type USING btree (id);


--
-- Name: ix_pos_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_pos_id ON pos USING btree (id);


--
-- Name: ix_pos_transactions_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_pos_transactions_id ON pos_transactions USING btree (id);


--
-- Name: ix_poz_transactions_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_poz_transactions_id ON poz_transactions USING btree (id);


--
-- Name: ix_price_config_term_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_price_config_term_id ON price_config_term USING btree (id);


--
-- Name: ix_price_feature_values_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_price_feature_values_id ON price_feature_values USING btree (id);


--
-- Name: ix_product_barcode_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_product_barcode_id ON product_barcode USING btree (id);


--
-- Name: ix_product_feature_values_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_product_feature_values_id ON product_feature_values USING btree (id);
...
CREATE INDEX ix_product_images_id ON product_images USING btree (id);


--
-- Name: ix_product_price_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_product_price_id ON product_price USING btree (id);


--
-- Name: ix_product_rate_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_product_rate_id ON product_rate USING btree (id);


--
-- Name: ix_rate_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_rate_id ON rate USING btree (id);


--
-- Name: ix_review_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_review_id ON review USING btree (id);


--
-- Name: ix_stock_taking_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_stock_taking_id ON stock_taking USING btree (id);


--
-- Name: ix_stock_taking_product_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_stock_taking_product_id ON stock_taking_product USING btree (id);


--
-- Name: ix_task_queue_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_task_queue_id ON task_queue USING btree (id);


--
-- Name: ix_transaction_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_transaction_id ON transaction USING btree (id);


--
-- Name: ix_transfer_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_transfer_id ON transfer USING btree (id);


--
-- Name: ix_unit_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_unit_id ON unit USING btree (id);


--
-- Name: ix_wallet_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_wallet_id ON wallet USING btree (id);


--
-- Name: ix_warehouse_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_warehouse_id ON warehouse USING btree (id);


--
-- Name: ix_warehouse_managers_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_warehouse_managers_id ON warehouse_managers USING btree (id);


--
-- Name: ix_warehouse_phones_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_warehouse_phones_id ON warehouse_phones USING btree (id);


--
-- Name: ix_wastage_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_wastage_id ON wastage USING btree (id);


--
-- Name: ix_withdraw_wallet_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_withdraw_wallet_id ON withdraw_wallet USING btree (id);


--
-- Name: bank_check bank_check_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_check
    ADD CONSTRAINT bank_check_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: bank_check bank_check_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_check
    ADD CONSTRAINT bank_check_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: bank_receipt bank_receipt_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_receipt
    ADD CONSTRAINT bank_receipt_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: bank_receipt bank_receipt_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY bank_receipt
    ADD CONSTRAINT bank_receipt_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: basket basket_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY basket
    ADD CONSTRAINT basket_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: basket basket_product_price_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY basket
    ADD CONSTRAINT basket_product_price_id_fkey FOREIGN KEY (product_price_id) REFERENCES product_price(id);


--
-- Name: basket basket_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY basket
    ADD CONSTRAINT basket_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES warehouse(id);


--
-- Name: brand_category brand_category_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_category
    ADD CONSTRAINT brand_category_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: brand_feature brand_feature_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_feature
    ADD CONSTRAINT brand_feature_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: brand_feature brand_feature_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_feature
    ADD CONSTRAINT brand_feature_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES feature(id);


--
-- Name: brand_feature brand_feature_feature_value_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_feature
    ADD CONSTRAINT brand_feature_feature_value_id_fkey FOREIGN KEY (feature_value_id) REFERENCES feature_value(id);


--
-- Name: brand_image brand_image_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY brand_image
    ADD CONSTRAINT brand_image_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: category_brand_price_action c_b_p_a_b_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand_price_action
    ADD CONSTRAINT c_b_p_a_b_fk FOREIGN KEY (brand_id) REFERENCES brand(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: category_brand category_brand_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand
    ADD CONSTRAINT category_brand_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: category_brand_price category_brand_price_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_brand_price
    ADD CONSTRAINT category_brand_price_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: category_feature category_feature_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_feature
    ADD CONSTRAINT category_feature_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES feature(id);


--
-- Name: category_list category_list_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_list
    ADD CONSTRAINT category_list_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: category_rate category_rate_rate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY category_rate
    ADD CONSTRAINT category_rate_rate_id_fkey FOREIGN KEY (rate_id) REFERENCES rate(id);


--
-- Name: cheque cheque_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque
    ADD CONSTRAINT cheque_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_cheque_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_cheque_id_fkey FOREIGN KEY (cheque_id) REFERENCES cheque(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_stock_taking_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_stock_taking_product_id_fkey FOREIGN KEY (stock_taking_product_id) REFERENCES stock_taking_product(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_transfer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_transfer_id_fkey FOREIGN KEY (transfer_id) REFERENCES transfer(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES unit(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES warehouse(id);


--
-- Name: cheque_transfer_product cheque_transfer_product_wastage_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque_transfer_product
    ADD CONSTRAINT cheque_transfer_product_wastage_id_fkey FOREIGN KEY (wastage_id) REFERENCES wastage(id);


--
-- Name: cheque cheque_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY cheque
    ADD CONSTRAINT cheque_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES warehouse(id);


--
-- Name: discount_calander_banner discount_calander_banner_discount_calander_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_banner
    ADD CONSTRAINT discount_calander_banner_discount_calander_id_fkey FOREIGN KEY (discount_calander_id) REFERENCES discount_calander(id);


--
-- Name: discount_calander_list_banner_category discount_calander_list_banner_ca_discount_calander_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_banner_category
    ADD CONSTRAINT discount_calander_list_banner_ca_discount_calander_list_id_fkey FOREIGN KEY (discount_calander_list_id) REFERENCES discount_calander_list(id);


--
-- Name: discount_calander_list_banner_category discount_calander_list_banner_category_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_banner_category
    ADD CONSTRAINT discount_calander_list_banner_category_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES brand(id);


--
-- Name: discount_calander_list_codes discount_calander_list_codes_discount_calander_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list_codes
    ADD CONSTRAINT discount_calander_list_codes_discount_calander_list_id_fkey FOREIGN KEY (discount_calander_list_id) REFERENCES discount_calander_list(id);


--
-- Name: discount_calander_list discount_calander_list_discount_calander_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_list
    ADD CONSTRAINT discount_calander_list_discount_calander_id_fkey FOREIGN KEY (discount_calander_id) REFERENCES discount_calander(id);


--
-- Name: discount_calander_msg discount_calander_msg_discount_calander_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg
    ADD CONSTRAINT discount_calander_msg_discount_calander_id_fkey FOREIGN KEY (discount_calander_id) REFERENCES discount_calander(id);


--
-- Name: discount_calander_msg_media discount_calander_msg_media_discount_calander_msg_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_media
    ADD CONSTRAINT discount_calander_msg_media_discount_calander_msg_id_fkey FOREIGN KEY (discount_calander_msg_id) REFERENCES discount_calander_msg(id);


--
-- Name: discount_calander_msg_reciever discount_calander_msg_reciever_discount_calander_msg_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY discount_calander_msg_reciever
    ADD CONSTRAINT discount_calander_msg_reciever_discount_calander_msg_id_fkey FOREIGN KEY (discount_calander_msg_id) REFERENCES discount_calander_msg(id);


--
-- Name: facktor_info facktor_info_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY facktor_info
    ADD CONSTRAINT facktor_info_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: feature_values_category feature_values_category_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feature_values_category
    ADD CONSTRAINT feature_values_category_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES feature(id);


--
-- Name: feature_values_category feature_values_category_feature_value_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feature_values_category
    ADD CONSTRAINT feature_values_category_feature_value_id_fkey FOREIGN KEY (feature_value_id) REFERENCES feature_value(id);


--
-- Name: financial_document financial_document_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
    ADD CONSTRAINT financial_document_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: financial_document financial_document_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
    ADD CONSTRAINT financial_document_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: financial_document financial_document_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
    ADD CONSTRAINT financial_document_transaction_id_fkey FOREIGN KEY (transaction_id) REFERENCES transaction(id);


--
-- Name: financial_document financial_document_wallet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
    ADD CONSTRAINT financial_document_wallet_id_fkey FOREIGN KEY (wallet_id) REFERENCES wallet(id);


--
-- Name: financial_document financial_document_withdraw_wallet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY financial_document
    ADD CONSTRAINT financial_document_withdraw_wallet_id_fkey FOREIGN KEY (withdraw_wallet_id) REFERENCES withdraw_wallet(id);


--
-- Name: holding_hands holding_hands_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY holding_hands
    ADD CONSTRAINT holding_hands_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: holding_hands holding_hands_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY holding_hands
    ADD CONSTRAINT holding_hands_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: log_price_action l_p_a_cbp_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY log_price_action
    ADD CONSTRAINT l_p_a_cbp_fk FOREIGN KEY (category_brand_price_action_id) REFERENCES category_brand_price_action(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: log_price_action l_p_a_pp_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY log_price_action
    ADD CONSTRAINT l_p_a_pp_fk FOREIGN KEY (product_price_id) REFERENCES product_price(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: warehouse_managers m_fk_w; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY warehouse_managers
    ADD CONSTRAINT m_fk_w FOREIGN KEY (warehouse_id) REFERENCES warehouse(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY order_products
    ADD CONSTRAINT order_products_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);
...
--
-- Name: order_send order_send_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY order_send
    ADD CONSTRAINT order_send_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: pos pos_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pos
    ADD CONSTRAINT pos_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: pos_transactions pos_transactions_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pos_transactions
    ADD CONSTRAINT pos_transactions_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: pos_transactions pos_transactions_pos_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pos_transactions
    ADD CONSTRAINT pos_transactions_pos_id_fkey FOREIGN KEY (pos_id) REFERENCES pos(id);


--
-- Name: poz_transactions poz_transactions_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poz_transactions
    ADD CONSTRAINT poz_transactions_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);


--
-- Name: poz_transactions poz_transactions_pos_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poz_transactions
    ADD CONSTRAINT poz_transactions_pos_id_fkey FOREIGN KEY (pos_id) REFERENCES pos(id);


--
-- Name: price_feature_values price_feature_values_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_feature_values
    ADD CONSTRAINT price_feature_values_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES feature(id);


--
-- Name: price_feature_values price_feature_values_feature_value_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_feature_values
    ADD CONSTRAINT price_feature_values_feature_value_id_fkey FOREIGN KEY (feature_value_id) REFERENCES feature_value(id);


--
-- Name: price_feature_values price_feature_values_product_price_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY price_feature_values
    ADD CONSTRAINT price_feature_values_product_price_id_fkey FOREIGN KEY (product_price_id) REFERENCES product_price(id);


--
-- Name: product_barcode product_barcode_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_barcode
    ADD CONSTRAINT product_barcode_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);
...
--
-- Name: product_feature_values product_feature_values_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_feature_values
    ADD CONSTRAINT product_feature_values_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES feature(id);


--
-- Name: product_feature_values product_feature_values_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_feature_values
    ADD CONSTRAINT product_feature_values_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);
...
--
-- Name: product_price product_price_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_price
    ADD CONSTRAINT product_price_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);
...
--
-- Name: product_price product_price_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_price
    ADD CONSTRAINT product_price_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES unit(id);


--
-- Name: product_rate product_rate_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_rate
    ADD CONSTRAINT product_rate_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: product_rate product_rate_rate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY product_rate
    ADD CONSTRAINT product_rate_rate_id_fkey FOREIGN KEY (rate_id) REFERENCES rate(id);
...
ALTER TABLE ONLY review
    ADD CONSTRAINT review_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: stock_taking stock_taking_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY stock_taking
    ADD CONSTRAINT stock_taking_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES warehouse(id);


--
-- Name: transaction transaction_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transaction
    ADD CONSTRAINT transaction_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: transaction transaction_pos_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transaction
    ADD CONSTRAINT transaction_pos_id_fkey FOREIGN KEY (pos_id) REFERENCES pos(id);
...
ALTER TABLE ONLY transaction
    ADD CONSTRAINT transaction_wallet_id_fkey FOREIGN KEY (wallet_id) REFERENCES wallet(id);


--
-- Name: wallet wallet_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wallet
    ADD CONSTRAINT wallet_order_id_fkey FOREIGN KEY (order_id) REFERENCES my_order(id);


--
-- Name: wastage wastage_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wastage
    ADD CONSTRAINT wastage_product_id_fkey FOREIGN KEY (product_id) REFERENCES product(id);


--
-- Name: wastage wastage_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wastage
    ADD CONSTRAINT wastage_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES unit(id);


--
-- Name: wastage wastage_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY wastage
    ADD CONSTRAINT wastage_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES warehouse(id);


--
-- Name: withdraw_wallet withdraw_wallet_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY withdraw_wallet
    ADD CONSTRAINT withdraw_wallet_account_id_fkey FOREIGN KEY (account_id) REFERENCES account(id);
